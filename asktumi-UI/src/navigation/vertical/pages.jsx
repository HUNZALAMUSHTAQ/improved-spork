...
const pages = [
  ...
  //             navLink: "https://yoda.AskTumi.studio/yoda-email-template/hello.html",
  //         },
  //         {
  //             id: "email-promotional",
  //             title: <IntlMessages id="sidebar-pages-email-promotional" />,
  //             navLink: "https://yoda.AskTumi.studio/yoda-email-template/promotional.html",
  //         },
  //         {
  //             id: "email-verify",
  //             title: <IntlMessages id="sidebar-pages-email-verify" />,
  //             navLink: "https://yoda.AskTumi.studio/yoda-email-template/verify.html",
  //         },
  //         {
  //             id: "email-reset-password",
  //             title: <IntlMessages id="sidebar-pages-email-reset-password" />,
  //             navLink: "https://yoda.AskTumi.studio/yoda-email-template/reset-password.html",
  //         },
  //         {
  //             id: "email-term",
  //             title: <IntlMessages id="sidebar-pages-email-term" />,
  //             navLink: "https://yoda.AskTumi.studio/yoda-email-template/term.html",
  //         },
  //         {
  //             id: "email-deactive-account",
  //             title: <IntlMessages id="sidebar-pages-email-deactive-account" />,
  //             navLink: "https://yoda.AskTumi.studio/yoda-email-template/deactive-account.html",
  //         },
  //     ],
  // },
  // {
  ...
  {
    id: "upload-workspace",
    title: <IntlMessages id="sidebar-pages-upload" />,
    icon: <Upload size={18} />,
    navLink: "/pages/upload",
  },
  // {
  //     id: "workspace",
  ...
  {
    id: "chatBot",
    title: <IntlMessages id="sidebar-pages-chatBot" />,
    icon: <Autonio size={18} />,
    navLink: "/pages/chatBot",
  },
  {
    id: "account-profile-information",
    title: <IntlMessages id="sidebar-pages-account-profile-information" />,
    icon: <Profile size={18} />,
    navLink: "/pages/profile/personel-information",
  },
  {
    id: "embed",
    title: <IntlMessages id="sidebar-pages-embed" />,
    icon: <ReceiptAdd size={18} />,
    navLink: "/pages/embed",
    show: "company",
  },
  // {
