            ...
            <Col lg={12} span={24}>
              <SelectBoxItem
                ...
                description={[
                  ...
                  <a href='mailto:hi-london@AskTumi.studio' className="hp-text-color-black-80 hp-text-color-dark-30 hp-hover-text-color-primary-1 hp-hover-text-color-dark-primary-2">hi-london@AskTumi.studio</a>,
