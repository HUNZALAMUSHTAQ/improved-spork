...
const _t = (t) => null == t,
  ...
  Rt =
    (nt(["click"]),
    ({ chatflowid: t, apiHost: e = "http://localhost:3001", body: r }) =>
      St({ method: "POST", url: e + "/api/v1/bot/" + t, body: r })),
  $t = st(
...
const ce = st(
  ...
  we =
    (nt(["click"]),
    st(
      '<span>Powered by<a target="_blank" rel="noopener noreferrer" class="lite-badge" id="lite-badge"><span> Asktumi'
    )),
  ve = "#303235",
  xe = (t) => {
    let e, r;
...
const Vr = (t) => {
  ...
  Qr = (t) => {
    ...
    const [n, o] = x(""),
      ...
      E =
        ...
        _(async () => {
          var e = (
            await (({ chatflowid: t, apiHost: e = "http://localhost:3001" }) =>
              St({ method: "GET", url: e + "/api/v1/bot/" + t }))({
              chatflowid: t.chatflowid,
              apiHost: t.apiHost,
            })
          ).data;
  ...
  ls =
    ("undefined" != typeof window &&
      (mt("flowise-fullchatbot", wt, os), mt("flowise-chatbot", wt, rs)),
    { initFull: is, init: as });
((t) => {
